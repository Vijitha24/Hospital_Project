...
def add_medical_report(request, appointment_id):
    ...
    if request.method == "POST":
        ...
        plan_care = request.POST.get("plan_care")
        base_models.MedicalRecord.objects.create(appointment=appointment, diagnosis=diagnosis, plan_care=plan_care,
                                                    past_history=past_history, examination=examination)
...
def add_lab_test(request, appointment_id):
    ...
    if request.method == "POST":
        ...
        base_models.LabTest.objects.create(appointment=appointment, test_name=test_name, description=description,
                                           result=result)
